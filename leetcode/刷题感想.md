...
27. [题134. 加油站](#num134)
28. [题136. 只出现一次的数字](#num136)
29. [题141. 环形链表](#num141)
30. [题142. 环形链表II](#num142)
31. [题144、94、145. 二叉树的前序、中序、后序遍历](#traversal_binaryTree)
32. [题164. 最大间距](#num164)（桶算法还未实现）
33. [题169. 多数元素](#num169)
34. [题198. 打家劫舍](#num198)
35. [题202. 快乐数](#num202)
36. [题204. 计数质数](#num204)
37. [题206. 反转链表](#num206)
38. **[题215. 数组中的第K个最大元素](#num215)**
39. [题225. 用队列实现栈](#num225)
40. [题226. 翻转二叉树](#num226)
41. [题237. 删除列表中的节点](#num237)
42. [题242. 有效的字母异位词](#num242)
43. [题283. 移动零](#num283)
44. [题328. 奇偶链表](#num328)
45. [题344. 反转字符串](#num344)
46. [题349. 两个数组的交集](#num349)
47. [题441. 排列硬币](#num441)
48. [题452. 用最少数量的箭引爆气球](#num452)
49. [题454. 四数相加II](#num454)
50. [题530. 二叉搜索树的最小绝对差](#num530)
51. [题559. N叉树的最大深度](#num559)
52. [题589. N叉树的前序遍历](#num589)
53. [题617. 合并二叉树](#num617)
54. [题654. 最大二叉树](#num654)
55. [题657. 机器人能否返回原点](#num657)
56. [题704. 二分查找](#num704)
57. [题771. 宝石与石头](#num771)
58. [题876. 链表的中间结点](#num876)
59. [题941. 有效山脉数组](#num941)
60. [题965. 单值二叉树](#num965)
61. [题976. 三角形的最大周长](#num976)
62. [题1356. 根据数字二进制下1的数目排序](#num1356)
63. [题1370. 上升下降字符串](#num1370)
64. [题1431. 拥有最多糖果的孩子](#num1431)
65. [题1480. 一维数组的动态和](#num1480)
66. [Offer03. 数组中重复的数字](#offer03)
67. [Offer06. 从尾到头打印链表](#offer06)
68. [Offer09. 用两个栈实现队列](#offer09)
69. [Offer 32-I. 从上到下打印二叉树](#offer32-1)
70. [Offer 32-III. 从上到下打印二叉树 III](#offer32-3)
71. [Offer36. 二叉搜索树和循环双向链表](#offer36)
72. [Offer 53-I. 在排序数组中查找数字 I](#offer53-1)
73. [Offer 54. 二叉搜索树的第k大节点](#offer54)
74. [Offer56-I. 数组中数字出现的次数](#offer56-1)
75. [Offer 57. 和为s的两个数字](#offer57)（待看正确性证明）
76. [inter0202. 返回倒数第k个节点](#inter0202)
## 题解
...
82. 题204. [计数质数](https://leetcode-cn.com/problems/count-primes/)<a name="num204"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201203193737880.png" alt="image-20201203193737880" style="zoom: 67%;" />
...
83. 题225. [用队列实现栈](https://leetcode-cn.com/problems/implement-stack-using-queues/)<a name="num225"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201203204004501.png" alt="image-20201203204004501" style="zoom:67%;" />
