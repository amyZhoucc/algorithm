...
15. [题69. x的平方根](#num69)
16. [题100. 相同的树](#num100)
17. [题101. 对称二叉树](#num101)
18. [题102. 二叉树的层序遍历](#num102)
19. [题104. 二叉树的最大深度](#num104)
20. [题105. 从前序与中序遍历序列构造二叉树](#num105)
21. [题111. 二叉树的最小深度](#num111)
22. [题112. 路径总和](#num112)
23. [题114. 二叉树展开为链表](#num114)（目前只有一个解法，还待补充）
24. [题116. 填充每个节点的下一个右侧节点指针](#num116)
25. [题117. 填充每个节点的下一个右侧节点指针II](#num117)
26. [题121. 买卖股票的最佳时机](#num121)
27. [题134. 加油站](#num134)
28. [题141. 环形链表](#num141)
29. [题142. 环形链表II](#num142)
30. [题144、94、145. 二叉树的前序、中序、后序遍历](#traversal_binaryTree)
31. [题164. 最大间距](#num164)（桶算法还未实现）
32. [题169. 多数元素](#num169)
33. [题198. 打家劫舍](#num198)
34. [题202. 快乐数](#num202)
35. [题206. 反转链表](#num206)
36. [题226. 翻转二叉树](#num226)
37. [题237. 删除列表中的节点](#num237)
38. [题242. 有效的字母异位词](#num242)
39. [题283. 移动零](#num283)
40. [题328. 奇偶链表](#num328)
41. [题344. 反转字符串](#num344)
42. [题349. 两个数组的交集](#num349)
43. [题441. 排列硬币](#num441)
44. [题452. 用最少数量的箭引爆气球](#num452)
45. [题454. 四数相加II](#num454)
46. [题530. 二叉搜索树的最小绝对差](#num530)
47. [题559. N叉树的最大深度](#num559)
48. [题589. N叉树的前序遍历](#num589)
49. [题617. 合并二叉树](#num617)
50. [题654. 最大二叉树](#num654)
51. [题657. 机器人能否返回原点](#num657)
52. [题704. 二分查找](#num704)
53. [题771. 宝石与石头](#num771)
54. [题876. 链表的中间结点](#num876)
55. [题941. 有效山脉数组](#num941)
56. [题965. 单值二叉树](#num965)
57. [题976. 三角形的最大周长](#num976)
58. [题1356. 根据数字二进制下1的数目排序](#num1356)
59. [题1370. 上升下降字符串](#num1370)
60. [题1431. 拥有最多糖果的孩子](#num1431)
61. [题1480. 一维数组的动态和](#num1480)
62. [Offer03. 数组中重复的数字](#offer03)
63. [Offer06. 从尾到头打印链表](#offer06)
64. [Offer09. 用两个栈实现队列](#offer09)
65. [Offer 32-I. 从上到下打印二叉树](#offer32-1)
66. [Offer 32-III. 从上到下打印二叉树 III](#offer32-3)
67. [Offer 53-1. 在排序数组中查找数字 I](#offer53-1)
68. [Offer 54. 二叉搜索树的第k大节点](#offer54)
69. [Offer 57. 和为s的两个数字](#offer57)（待看正确性证明）
70. [inter0202. 返回倒数第k个节点](#inter0202)
## 题解
...
78. Offer03. [数组中重复的数字](https://leetcode-cn.com/problems/shu-zu-zhong-zhong-fu-de-shu-zi-lcof/)<a name="offer03"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201130203248902.png" alt="image-20201130203248902" style="zoom:67%;" />
...
79. 题202. [快乐数](https://leetcode-cn.com/problems/happy-number/)<a name="num202"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201201192617186.png" alt="image-20201201192617186" style="zoom: 67%;" />
    ...
    - 超范围问题，我们可以想一下
      ...
      <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201201193541688.png" alt="image-20201201193541688" style="zoom:67%;" />

      所以随着无限执行下去，不会出现无穷大的情况

    - 那么无法到达1，那么就出现了一个循环——可能不断在多个数之间来回转换（注意是多个数的循环——而不是前后相等）

      <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201201193900897.png" alt="image-20201201193900897" style="zoom: 50%;" />
      ...
      <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201201200320430.png" alt="image-20201201200320430" style="zoom:50%;" />
      ...
      <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201201200131955.png" alt="image-20201201200131955" style="zoom: 50%;" />
