...
14. [题35. 搜索插入位置](#num35)
15. M【回溯】[题46. 全排列](#num46)
16. [题69. x的平方根](#num69)
17. [题100. 相同的树](#num100)
18. [题101. 对称二叉树](#num101)
19. [题102. 二叉树的层序遍历](#num102)
20. [题104. 二叉树的最大深度](#num104)
21. [题105. 从前序与中序遍历序列构造二叉树](#num105)
22. [题111. 二叉树的最小深度](#num111)
23. [题112. 路径总和](#num112)
24. [题114. 二叉树展开为链表](#num114)（目前只有一个解法，还待补充）
25. [题116. 填充每个节点的下一个右侧节点指针](#num116)
26. [题117. 填充每个节点的下一个右侧节点指针II](#num117)
27. S【数学，数组】[题118. 杨辉三角](#num118)
28. [题121. 买卖股票的最佳时机](#num121)
29. [题134. 加油站](#num134)
30. [题136. 只出现一次的数字](#num136)
31. [题141. 环形链表](#num141)
32. [题142. 环形链表II](#num142)
33. [题144、94、145. 二叉树的前序、中序、后序遍历](#traversal_binaryTree)
34. [题164. 最大间距](#num164)（桶算法还未实现）
35. [题169. 多数元素](#num169)
36. S【位运算】 [题190. 颠倒二进制位](#num190)（题解有意思）（未完待续）
37. S【位运算】[题191. 位1的个数](#num191)
38. [题198. 打家劫舍](#num198)
39. [题202. 快乐数](#num202)
40. [题204. 计数质数](#num204)
41. [题206. 反转链表](#num206)
42. **[题215. 数组中的第K个最大元素](#num215)**
43. M【回溯】[题216. 组合总和III](#num216)
44. [题225. 用队列实现栈](#num225)
45. [题226. 翻转二叉树](#num226)
46. S【位运算】[题231. 2的幂](#num231)
47. [题237. 删除列表中的节点](#num237)
48. [题242. 有效的字母异位词](#num242)
49. [题283. 移动零](#num283)
50. [题328. 奇偶链表](#num328)
51. M【动态规划，位运算】[题338. 比特位计数](#num338)
52. [题344. 反转字符串](#num344)
53. [题349. 两个数组的交集](#num349)
54. [题441. 排列硬币](#num441)
55. [题452. 用最少数量的箭引爆气球](#num452)
56. [题454. 四数相加II](#num454)
57. [题530. 二叉搜索树的最小绝对差](#num530)
58. [题559. N叉树的最大深度](#num559)
59. [题589. N叉树的前序遍历](#num589)
60. [题617. 合并二叉树](#num617)
61. [题654. 最大二叉树](#num654)
62. [题657. 机器人能否返回原点](#num657)
63. [题704. 二分查找](#num704)
64. [题762. 二进制表示中质数个计算置位](#num762)
65. [题771. 宝石与石头](#num771)
66. M【贪心，位权重】[题861. 翻转矩阵后的得分](#num861)
67. [题876. 链表的中间结点](#num876)
68. [题941. 有效山脉数组](#num941)
69. [题965. 单值二叉树](#num965)
70. [题976. 三角形的最大周长](#num976)
71. [题1356. 根据数字二进制下1的数目排序](#num1356)
72. [题1370. 上升下降字符串](#num1370)
73. [题1431. 拥有最多糖果的孩子](#num1431)
74. [题1480. 一维数组的动态和](#num1480)
75. [Offer03. 数组中重复的数字](#offer03)
76. [Offer06. 从尾到头打印链表](#offer06)
77. [Offer09. 用两个栈实现队列](#offer09)
78. [Offer 32-I. 从上到下打印二叉树](#offer32-1)
79. [Offer 32-III. 从上到下打印二叉树 III](#offer32-3)
80. [Offer36. 二叉搜索树和循环双向链表](#offer36)
81. [Offer 53-I. 在排序数组中查找数字 I](#offer53-1)
82. [Offer 54. 二叉搜索树的第k大节点](#offer54)
83. [Offer56-I. 数组中数字出现的次数](#offer56-1)
84. [Offer 57. 和为s的两个数字](#offer57)（待看正确性证明）
85. [inter0202. 返回倒数第k个节点](#inter0202)
## 题解
...
90. 题861. [翻转矩阵后的得分](https://leetcode-cn.com/problems/score-after-flipping-matrix/)<a name="num861"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201207220201927.png" alt="image-20201207220201927" style="zoom: 60%;" />
...
91. 题216. [组合总和 III](https://leetcode-cn.com/problems/combination-sum-iii/)<a name="num216"></a>
    ...
    <img src="C:\Users\surface\AppData\Roaming\Typora\typora-user-images\image-20201208181049122.png" alt="image-20201208181049122" style="zoom:67%;" />
    
    求组合的题，一般需要用到回溯——类似于枚举，遍历所有的可能，记录满足条件的值
    
    具体看：[常见算法及实现整理](https://github.com/amyZhoucc/algorithm/blob/master/%E5%B8%B8%E8%A7%81%E7%AE%97%E6%B3%95%E5%8F%8A%E5%AE%9E%E7%8E%B0%E6%95%B4%E7%90%86.md#%E5%9B%9B%E5%9B%9E%E6%BA%AF%E7%AE%97%E6%B3%95)
