...
12. [题104. 二叉树的最大深度](#num104)(未完)

13. [题121. 买卖股票的最佳时机](#num121)

14. [题144、94、145. 二叉树的前序、中序、后序遍历](#traversal_binaryTree)(未完)
...
20. [题876. 链表的中间结点](#num876)

21. [题1431. 拥有最多糖果的孩子](#num1431)

22. [Offer 53-1. 在排序数组中查找数字 I](#offer53-1)

23. 题2：[两数相加](https://leetcode-cn.com/problems/add-two-numbers/)<a name="num2"></a>
...
24. 题1431：[拥有最多糖果的孩子](https://leetcode-cn.com/problems/kids-with-the-greatest-number-of-candies/)<a name="num1431"></a>
...
25. 题19：[删除链表的倒数第N个节点](https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list/)<a name="num19"></a>
...
26. 题21：[合并两个有序链表](https://leetcode-cn.com/problems/merge-two-sorted-lists/)<a name="num21"></a>
...
27. 题27：[移除元素](https://leetcode-cn.com/problems/remove-element/)<a name="num27"></a>
...
28. 题206：[反转链表](https://leetcode-cn.com/problems/reverse-linked-list/)<a name="num206"></a>
...
29. 题26：[删除排序数组中的重复项](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/)<a name="num26"></a>
...
30. 题328：[奇偶链表](https://leetcode-cn.com/problems/odd-even-linked-list/)<a name="num328"></a>
...
31. 题876：[链表的中间结点](https://leetcode-cn.com/problems/middle-of-the-linked-list/)<a name="num876"></a>
...
32. 题11：[盛最多水的容器](https://leetcode-cn.com/problems/container-with-most-water/)<a name="num11"></a>
...
33. 题7：[整数反转](https://leetcode-cn.com/problems/reverse-integer/)<a name="num7"></a>
...
34. 题24：[两两交换链表中的节点](https://leetcode-cn.com/problems/swap-nodes-in-pairs/)<a name="num24"></a>
...
35. 题121：[买卖股票的最佳时机](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock/)<a name="num121"></a>
...
36. 题283：[移动零](https://leetcode-cn.com/problems/move-zeroes/)<a name="num283"></a>
...
37. 题35：[搜索插入位置](https://leetcode-cn.com/problems/search-insert-position/)<a name="num35"></a>
...
38. 题704：[二分查找](https://leetcode-cn.com/problems/binary-search/)<a name="num704"></a>

    <img src="pic\image-20200806173503684.png" alt="image-20200806173503684" style="zoom:67%;" />

    很典型的二分查找题，不需要变型，直接套用即可。

39. 题34：[在排序数组中查找元素的第一个和最后一个位置](https://leetcode-cn.com/problems/find-first-and-last-position-of-element-in-sorted-array/)<a name="num34"></a>

    <img src="pic\image-20200807101918176.png" alt="image-20200807101918176" style="zoom:67%;" />

    典型的二分查找寻找边界的问题，具体见之前的整理

40. 题69：[x 的平方根](https://leetcode-cn.com/problems/sqrtx/)<a name="num69"></a>
...
41. 题441：[排列硬币](https://leetcode-cn.com/problems/arranging-coins/)<a name="num441"></a>
...
42. 题offer 53-1：[在排序数组中查找数字 I](https://leetcode-cn.com/problems/zai-pai-xu-shu-zu-zhong-cha-zhao-shu-zi-lcof/)<a name="offer53-1"></a>
...
43. 题104：[二叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/)<a name="num104"></a>

    <img src="C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20200811112830845.png" alt="image-20200811112830845"  />
...
44. 题144：[二叉树的前序遍历](https://leetcode-cn.com/problems/binary-tree-preorder-traversal/)<a name="traversal_binaryTree"></a>
...
45. 题94：[二叉树的中序遍历](https://leetcode-cn.com/problems/binary-tree-inorder-traversal/)
...
46. 题145：[二叉树的后序遍历](https://leetcode-cn.com/problems/binary-tree-postorder-traversal/)
